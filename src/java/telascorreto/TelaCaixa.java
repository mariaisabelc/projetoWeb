...
public class TelaCaixa extends javax.swing.JFrame {
    ...
    public void atualizarTabelaCaixa() {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/pi", "root", "1111");
            ...
            while (resultSet.next()) {
                String dataVenda = resultSet.getString("dataVenda");
                int idVenda = resultSet.getInt("id");
                double valorVenda = resultSet.getDouble("valor");

                double saldo = calcularSaldo(model);

                model.addRow(new Object[]{dataVenda, idVenda, valorVenda, saldo});
            }
    ...
    private double calcularSaldo(DefaultTableModel model) {
        double saldo = 0;
        for (int i = 0; i < model.getRowCount(); i++) {
            saldo += (double) model.getValueAt(i, 2);
        }
